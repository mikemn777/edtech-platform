...
const HIGH_RISK = new Set([PERMISSIONS.ROLE_ASSIGN, PERMISSIONS.USER_MANAGE]);
...
const ROLES = [
    {
        name: 'super_admin',
        family: client_1.RoleFamily.OPERATIONAL,
    ...
    {
        name: 'tutor',
        family: client_1.RoleFamily.ACTOR,
...
const LANGUAGES = [
    { code: 'en', name: 'English', direction: client_1.TextDirection.LTR },
    { code: 'ar', name: 'العربية', direction: client_1.TextDirection.RTL },
    { code: 'tr', name: 'Türkçe', direction: client_1.TextDirection.LTR },
];
